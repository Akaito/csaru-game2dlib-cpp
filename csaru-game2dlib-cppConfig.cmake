...
#	csaru-game2dlib-cpp_LIBRARIES, to any other CMake project that finds this
#	one via find_package().  That project can then use
#	target_link_libraries() with csaru-game2dlib-cpp_LIBRARIES to make its
#	linker aware of this project's compiled libraries.
if (WIN32)
    file(GLOB_RECURSE csaru-game2dlib-cpp_LIBRARIES "${CMAKE_CURRENT_LIST_DIR}/../static/*.lib")
else()
    file(GLOB_RECURSE csaru-game2dlib-cpp_LIBRARIES "${CMAKE_CURRENT_LIST_DIR}/../static/*.a")
endif()
